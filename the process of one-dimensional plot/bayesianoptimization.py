...
#candidates_of_X=X_candidate
    ...
    gaussian_process_model = GaussianProcessRegressor(n_restarts_optimizer=5)
    ...
    if acquisition_function_flag == 1:
        ...
        acquisition_function_values = (autoscaled_estimated_y_test 
                                      ...
                                      1.0*autoscaled_std_of_estimated_y_test * \
...
def bayesianoptimization_af(X, y, candidates_of_X, acquisition_function_flag, cumulative_variance=None):
    """
    Bayesian optimization
